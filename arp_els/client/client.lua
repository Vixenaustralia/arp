                    ...
                    if vehN ~= 0 then
                        ...
                        if (panelType == "original") then
                            ...
                            if IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 11) then
                                ...
                                TriggerEvent("tkdn:on", true)
                            else
                                TriggerEvent("tkdn:off", true)
