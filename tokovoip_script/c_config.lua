TokoVoipConfig = {
	...
	wsServer = "139.99.130.176:3000", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSChannel = "In-Game Chat",
		TSPassword = "tokovoipchannel", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "In Game Chat Waiting Room",

		-- Blocking screen informations
		TSServer = "ts.australianroleplay.com", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "Support", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "https://teamspeak.com/en/downloads/", -- Download link displayed on blocking screen
